(function (Kano) {
    ...
    let register = (Blockly) => {
        ...
        Blockly.Pseudo.init = () => {
            ...
            if (!Blockly.Pseudo.variableDB_) {
                Blockly.Pseudo.variableDB_ = new Blockly.Names();
            } else {
        ...
        Blockly.Pseudo.variables_get = function (block) {
            // Variable getter.
            var code = Blockly.Pseudo.variableDB_.getName(block.getFieldValue('VAR'), Blockly.Variables.NAME_TYPE);
            return [code];
        };
        ...
        Blockly.Pseudo.variables_set = function (block) {
            ...
            var argument0 = Blockly.Pseudo.valueToCode(block, 'VALUE') || '0',
                varName = Blockly.Pseudo.variableDB_.getName(block.getFieldValue('VAR'), Blockly.Variables.NAME_TYPE);
    ...
    Kano.MakeApps.Blockly.addModule('pseudo', {
        register
    });
