...
import '../../../../elements/kano-gif-creator/kano-gif-creator.js';
import { UIMixin } from '../../../../elements/part/kano-ui-behavior.js';

class KanoPartPictureList extends BaseMixin(UIMixin(PolymerElement)) {
    static get is() { return 'kano-part-picture-list'; }
    static get template() {
        return html`
...
customElements.define(KanoPartPictureList.is, KanoPartPictureList);
